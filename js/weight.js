!function () {
    ...
    function (a, b, c) {
                    ...
                    return x(a,function (a) {
                        ...
                        delegate_fn = function (d) {
                            ...
                            function (a) {
                                ...
                                if (null === i || i === b.body) return !1; (i.tagName.toLowerCase() === e || T.has(i, h)) && (d = K.handler.call(d, i, j, g))
        ...
        C.version = d,
        "undefined" != typeof MINGDAO_GLOBAL && (MINGDAO_GLOBAL.Qatrix = C),
        L(function () {
    ...
    function (a, b) {
        ...
        if (f) {
            ...
            a.mingdao_minWidth && (e.imageMinWidth = mingdao_minWidth),
            a.mingdao_minHeight && (e.imageMinHeight = mingdao_minHeight),
            e.md = a.mingdao_md || e.md || "",
            h.inner = "分享",
            "large" == h.size && (h.inner = "分享到明道");
            var k = c.$new("iframe", {
                src: e.analyticsUrl
            });
    ...
    function (a) {
        ...
        a.styles = "";
        for (var e in c) c[e] = b.$string.replace(c[e], {
            "{{imgBase}}": a.settings.imgBase
        }),
        a.styles += "#" + a.settings.id + " " + e.replace(/\./g, "." + a.settings.prefix) + " {" + c[e] + "} ";
        a.styles += "<!--[if IE 6]>";
        for (var e in d) a.styles += "#" + a.settings.id + " " + e.replace(/\./g, "." + a.settings.prefix) + " " + d[e] + " ";
        a.styles += "<![endif]-->"
    }(MINGDAO_GLOBAL),
    function (a) {
        {
            var b = a.Qatrix;
            a.settings.mingdaoUrl
        }
        a.templates = {
        ...
        for (var c in a.templates) a.templates[c] = b.$string.replace(a.templates[c], {
            "{{imgBase}}": a.settings.imgBase,
            "{{mingdaoUrl}}": a.settings.mingdaoUrl
        });
        a.render = function (c, d) {
            ...
            g = f.childNodes[0];
            return b.$each(f.getElementsByTagName("*"),
            function (c) {
    ...
    function (a) {
                ...
                if (a.length) {
                    ...
                    function (a) {
                        if (!a.imgUrl.match(/img.t.sinajs.cn/)) {
                            ...
                            e = b.$findParent(a.elem,
                            function (a) {
                                return b.$class(a, "WB_time").length && b.$class(a, "WB_text").length
                            });
                            d && e && (a.url = b.$class(e, "WB_time")[0].href, a.description = b.$class(e, "WB_text")[0].innerText),
                            c.push(a)
                        }
                    }),
                    c
        ...
        a.videoSiteRules = {
            "^https?://v.youku.com": function () {
                if (window.videoId2) {
                    ...
                    return {
                        imgUrl: a.settings.mingdaoUrl + "/pins/create/video/swf?url=" + encodeURIComponent(b),
                        size: {
                            x: 448,
                            y: 252
                        },
            ...
            "^https?://(www|yule).iqiyi.com": function () {
                ...
                if (c) {
                    ...
                    return {
                        imgUrl: a.settings.mingdaoUrl + "/pins/create/video/qiyi/?id=" + d,
                        size: {
                            x: 115,
                            y: 77
                        },
            ...
            "^https?://www.56.com/u": function () {
                ...
                return c = c[1],
                {
                    imgUrl: a.settings.mingdaoUrl + "/pins/create/video/56/?id=" + c,
                    size: {
                        x: 480,
                        y: 405
                    },
            ...
            "^https?://v.pptv.com/show": function () {
                return {
                    imgUrl: a.settings.mingdaoUrl + "/pins/create/video/pptv/?id=" + webcfg.id,
                    size: {
                        x: 120,
                        y: 60
                    },
        ...
        a.embedVideoRules = {
            "(player.youku.com/player|www.tudou.com|player.ku6.com/refer|player.56.com|player.pptv.com/v)": function (b) {
                return {
                    imgUrl: a.settings.mingdaoUrl + "/pins/create/video/swf?url=" + encodeURIComponent(b.url),
                    size: {
                        x: 448,
                        y: 336
                    },
            ...
            "share.vrs.sohu.com/my/v.swf.+?&id=(.+?)&autoplay=": function (b) {
                ...
                return {
                    imgUrl: a.settings.mingdaoUrl + "/pins/create/video/mysohu/?id=" + c,
                    size: {
                        x: 480,
                        y: 360
                    },
            ...
            "share.vrs.sohu.com/(.+?)/v.swf": function (b) {
                ...
                return {
                    imgUrl: a.settings.mingdaoUrl + "/pins/create/video/sohu/?id=" + c,
                    size: {
                        x: 480,
                        y: 360
                    },
            ...
            "v.ifeng.com/include/exterior.swf": function (b) {
                ...
                d = c.exec(b.url);
                return d ? (d = d[1], {
                    imgUrl: a.settings.mingdaoUrl + "/pins/create/video/ifeng/?id=" + d,
                    size: {
                        x: 480,
                        y: 360
                    },
            ...
            "player.yinyuetai.com": function (b) {
                ...
                if (!d) return !1;
                d = d[1];
                var e = b.url.indexOf("video") > 0 ? a.settings.mingdaoUrl + "/pins/create/video/yinyuetai/?id=" + d : a.settings.mingdaoUrl + "/pins/create/video/yytList/?id=" + d;
                return {
                    imgUrl: e,
                    size: {
                        x: 480,
            ...
            "www.jifenzhong.com/external": function (b) {
                ...
                d = c.exec(b.url);
                return d ? (d = d[1], {
                    imgUrl: a.settings.mingdaoUrl + "/pins/create/video/jfz/?id=" + d,
                    size: {
                        x: 480,
                        y: 305
                    },
            ...
            a.collector = {
                ...
                buildImgUnit: function (b) {
                    ...
                    return d ? {
                        ...
                        description: c.$attr.get(b, "alt") || c.$attr.get(b, "title") || "",
                        type: "img"
                    } : null
                },
    ...
    function (global, win) {
        ...
        global.popup = {
            single: function (c, d) {
                ...
                "video" == c.type && (f.video = c.video, f.media_type = 1);
                for (var g in f) e.push(encodeURIComponent(g)),
                e.push("="),
    ...
    function (a, b) {
        ...
        a.ui = {
            buildElements: function () {
                ...
                g = this.waterfallEl = c.$class(e, "MINGDAO-waterfall")[0],
                h = c.$new("style"),
                i = c.$class(e, "MINGDAO-close")[0],
                j = c.$class(e, "MINGDAO-sync"),
                k = c.$class(e, "MINGDAO-multi-buttons")[0],
                l = c.$class(k, "MINGDAO-confirm")[0],
                m = c.$class(k, "MINGDAO-cancel")[0],
                n = this.multiNoti = c.$class(e, "MINGDAO-multi-noti")[0],
                o = c.$tag(n, "b")[0],
                p = c.$tag(n, "i")[0],
                q = (this.noticeEl = c.$class(e, "MINGDAO-notice")[0], c.$class(e, "MINGDAO-switch-order")[0]);
                ...
                c.$event.on(e, "click", ".MINGDAO-img-holder", {},
                function (b) {
                    if (!c.$className.has(b.target, "MINGDAO-select-btn")) {
                        var e = c.$findParent(this,
                        function (a) {
                            return c.$className.has(a, "MINGDAO-cell")
                        });
                        return d.isInMultiMode ? c.$class(e, "MINGDAO-select-btn")[0].click() : void a.popup.single(e.unit)
                    }
                }),
                c.$event.on(e, "click", ".MINGDAO-select-btn", {},
                function () {
                    var b = c.$findParent(this,
                    function (a) {
                        return c.$className.has(a, "MINGDAO-cell")
                    });
                    c.$className.has(b, "MINGDAO-selected") ? (c.$className.remove(b, "MINGDAO-selected"), d.hideNotice()) : c.$class(e, "MINGDAO-selected").length >= a.settings.maximumSelect ? d.showNotice("一次最多选择 " + a.settings.maximumSelect + " 张图片") : c.$className.add(b, "MINGDAO-selected");
                    var f = c.$class(e, "MINGDAO-selected");
            ...
            buildCells: function (b) {
                ...
                function (b) {
                    ...
                    if (e.unit = b, d.pinnedUrls) for (var f = d.pinnedUrls.length - 1; f >= 0; f--) d.pinnedUrls[f] == b.imgUrl && c.$className.add(e, "MINGDAO-pinned");
                    if (b.imgHeight > a.settings.waterfallLimit && c.$className.add(e, "MINGDAO-long"), "video" == b.type && c.$className.add(e, "MINGDAO-video"), c.$append(d.waterfallEl, e), c.$browser.msie6) {
                        var g = c.$class(e, "MINGDAO-over")[0],
                        h = c.$class(e, "MINGDAO-img-holder")[0];
                        c.$style.set(g, "height", h.offsetHeight + "px"),
            ...
            initTextEl: function (b) {
                function d() {
                    e.unit.description = b.innerHTML,
            ...
            activeMultiMode: function () {
                this.isInMultiMode || (this.isInMultiMode = !0, c.$className.add(this.mainEl, "MINGDAO-multi"), c.$show(c.$class(this.mainEl, "MINGDAO-multi-buttons")[0]), c.$hide(c.$class(this.mainEl, "MINGDAO-logo")[0]), c.$show(this.multiNoti))
            },
            quitMultiMode: function () {
                this.isInMultiMode && (this.isInMultiMode = !1, c.$className.remove(this.mainEl, "MINGDAO-multi"), c.$hide(c.$class(this.mainEl, "MINGDAO-multi-buttons")[0]), c.$show(c.$class(this.mainEl, "MINGDAO-logo")[0]), c.$hide(this.multiNoti), c.$class(this.mainEl, "MINGDAO-selected",
                function (a) {
                    c.$className.remove(a, "MINGDAO-selected")
                }))
            },
            ...
            pinComplete: function (a) {
                ...
                this.waterfallEl && c.$class(this.waterfallEl, "MINGDAO-cell",
                function (b) {
                    b.unit.imgUrl == a && c.$className.add(b, "MINGDAO-pinned")
                })
            },
        ...
        a.interface = {
            ...
            pinImage: function (c, d) {
                var e = {
                    ...
                    description: b.$attr.get(c, "alt") || b.$attr.get(c, "title") || "",
                    type: "img"
                },
                f = a.collector.handleUnitsByRule([e]);
                f && f.length && (e = f[0]),
                a.collector.fillDescriptions([e]),
                a.popup.single(e, d)
            },
    ...
    function (a) {
        ...
        b("message",
        function (b) {
            if (b.origin == a.settings.mingdaoUrl) if ("multiUnits" == b.data) a.popup.sendExportUnits();
